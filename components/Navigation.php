...
<nav class='border-bottom mt-2'>
    <ul class='d-flex justify-content-evenly align-items-center list-unstyled px-3 py-1'>
        <?= $_SERVER['PHP_SELF'] == 'trackify-bugtracker.herokuapp.com/index.php'? 
        ...
        ?>
        <?= $_SERVER['PHP_SELF'] == 'trackify-bugtracker.herokuapp.com/tickets.php'? 
        ...
        ?>
        <?= $_SESSION['userAdmin']? $_SERVER['PHP_SELF'] == 'trackify-bugtracker.herokuapp.com/administration.php'? 
